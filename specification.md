...
| key | Unique workflow key. Alternative to the workflow identifier | string | yes if `id` not defined |
| name | Workflow name | string | yes |
| description | Workflow description | string | no |
| version | Workflow version | string | no |
| labels | List of helpful terms describing the workflows intended purpose, subject areas, or other important qualities | string | no |
...
The `key` property defines the unique, domain-specifc workflow key. It is used as an alternative to the workflow `id`
property in the cases where id cannot be used (for example needs to be auto-generated by a content-management system, etc).
`id` and `key` are mutually exclusive, meaning you cannot define both.
...
The `labels` property defines a list of helpful terms describing the workflows intended purpose, subject areas, or other important qualities,
