...
The `key` property defines the unique, domain-specific workflow instance identifier. It is an expression used by runtimes to
determine the unique identifier of instances against their input data.
...
If this workflow is instanciated with the following data...:
...
... the resulting workflow instance would get the '1234' unique identifier.
